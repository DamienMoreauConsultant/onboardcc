...
export default function Candidate() {
  ...
  useEffect(() => {
    ...
    void Promise.all([
      ...
      setError('');
    }).catch((err: any) => setError(err?.response?.data?.error ?? 'Impossible de charger votre espace. Réessayez, ou déconnectez-vous puis reconnectez-vous.'));
  }, [user?.id_candidat]);
